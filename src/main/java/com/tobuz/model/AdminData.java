...
public class AdminData extends BaseEntity{
	...
	private Double incrementMultipleEarning;
	
	private Double decrementMultipleEarning;
	...
	public Double getIncrementMultipleEarning() {
		return incrementMultipleEarning;
	}

	public void setIncrementMultipleEarning(Double incrementMultipleEarning) {
		this.incrementMultipleEarning = incrementMultipleEarning;
	}

	public Double getDecrementMultipleEarning() {
		return decrementMultipleEarning;
	}

	public void setDecrementMultipleEarning(Double decrementMultipleEarning) {
		this.decrementMultipleEarning = decrementMultipleEarning;
	}
	...
	/*
	 * public static Model.Finder<Long, AdminData> find = new Model.Finder<Long,
	...
	/*
	 * public static AdminData getAdminData(){ return
	 * AdminData.find.setMaxRows(1).findUnique(); }
	 */
