						...
						<div class="col-lg-3 col-xl-3 col-md-4 mobile-view">
							...
							<div class="dropdown dashboard">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									...
									<div class="listing">
										<a href="adminListings">My Listings</a>
									</div>
									<div class="My-Adverts">
										<a href="adminAdverts">Adverts</a>
									</div>
									<div class="My-Packages">
										<a href="adminPackages">Packages & Features</a>
									</div>
									<div class="categories">
										<a href="adminCategories">Categories</a>
									</div>
							...
							<div class="row">
								<!-- <div class="col-lg-12 col-xl-12 col-md-12">
									...
									<option value="BUSINESS_SERVICE">Business Service</option>
									 ...
									 </select> <button type="button" class="btn btn-secondary" onclick="getTobuzPackagesByUser()">Search</button>
									 <br/>
									 </div>
									 <br/>
	 ...
	 var getUrl = window.location;
	  ...
	  $.ajax({
	        ...
	        success: function (data) {
	        	...
	        	url = getUrl .protocol + "//" + getUrl.host + "/getTobuzFeatures" ;
