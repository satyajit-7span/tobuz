...
<div>
<div class="my-destboard"><a href="adminDashboard">My Dashboard</a></div>
<div class="payment-active"><a href="#">Payments</a></div>
<div class="listing"><a href="adminListings">My Listings</a></div>
<div class="My-Adverts"><a href="adminAdverts">Adverts</a></div>
<div class="My-Packages"><a href="adminPackages">Packages & Features</a></div>
<div class="categories"><a href="adminCategories">Categories</a></div>
<div class="user"><a href="adminUsers">User</a></div>
<div class="roles"><a href="#">Roles</a></div>
<div class="Messages"><a href="adminMessages">Messages</a></div>
<div class="data"><a href="adminData">Data</a></div>
<div class="user-requests"><a href="adminUserRequests">User Requests</a></div>
<div class="contact-detail"><a href="adminContactUs">Contact US Details</a></div>
</div>
</div>
...
<div class="profile-deshboard payment-box">
<h3 class="payment-title">Country</h3>
<form class="mt-10">
<div class="row">
<div class="col-3">
...
<div class="col-lg-4 col-xl-4 col-md-12">
<div class="profile-deshboard payment-box">
<h3 class="payment-title">User List</h3>
<form class="mt-10">
<div class="row">
<div class="col-5">
<div class="form-check">
...
<div class="col-lg-4 col-xl-4 col-md-12">
<div class="profile-deshboard payment-box Date">
<h3 class="payment-title">Date</h3>
<form class="mt-10">
<!-- Name start -->
<div class="input-group">
                <input class="form-control bg-transparent py-2 login-user" type="date" value="date1" id="example-input">
                </div>
<!-- Name finish -->
<!-- Name start -->
<div class="input-group">
...
<!-- Name finish -->
<button type="submit" class="btn Search-Data">Search Data </button>
</form>
</div>
</div>
</div>
<div class="row">
<!-- <div class="col-lg-5 col-xl-7 col-6 pr0 col-md-6">
bfs Sort By start
<div class="payment-show"><span class="payment-show-text">Show</span>
<span class="paymentselect"> 
<select>
...
</select></span> <span class="payment-show-text"> entries</span></div>
bfs Sort By finish

</div>
 -->
<!-- <div class="col-lg-7 col-xl-5 col-6 col-md-6">
Searchbar scrolling top desktop start
<div class="search-payments-title">Search payments here:</div>
<div class="search-payments-bar"><div class="input-group">
  <input type="search" class="form-control round-bar" aria-label="Search" aria-describedby="search-addon" />
  <button type="button" class="btn round-button"><i class="fa fa-search"></i></button>
</div>
Searchbar scrolling top desktop finish
</div></div> -->
...
<table>
  ...
  <tr>
    <td>1</td>
    <td>Abdul majeed kk</td>
    <td>Buyer</td>
	<td>Tobuz | SILVER Package sale by
the user Abdul majeed kk
and 543774123</td>
	<td>UAE</td>
	<td>200</td>
	<td>06/02/23 04:50</td>
	<td>Cancelled</td>
	<td><a href="#" class="open-popup" data-id="popup_default">INVOICE</a></td>
  </tr>
  <tr>
    <td>2</td>
    <td>Edoardo Rossi</td>
...
<div id="popup_default" class="popup">
  ...
  <div class="popup-content">
    ...
    <div class="logo-center"><a href="index"><img src="images/logo.png" alt="tobuz" title="Tobuz"></a></div>
<div class="invoice-area">
<div class="row">
<div class="col-lg-4 col-xl-4 col-md-4"><p><span>Invoice Id :</span> 74428022023013531</p></div>
<div class="col-lg-4 col-xl-4 col-md-4"><p><span>Client Name :</span> Saleem</p></div>
<div class="col-lg-4 col-xl-4 col-md-4"><p><span>Issue Date :</span> 2023/02/28</p></div>
<div class="col-lg-4 col-xl-4 col-md-4"><p><span>AFTER :</span> 0</p></div>
<div class="col-lg-4 col-xl-4 col-md-4"><p><span>Location :</span> Hyderabad Telangana India</p></div>
</div>
</div>
...
<table>
  ...
  <tr>
    ...
    <td align="left">Tobuz | SILVER Package sale by the user Saleem and 9867714349</td>
...
/*look for any elements with the class "paymentselect":*/
x = document.getElementsByClassName("paymentselect");
l = x.length;
for (i = 0; i < l; i++) {
