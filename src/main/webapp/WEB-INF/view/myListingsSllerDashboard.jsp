...
<html lang="en">
<head>
  <title>Tobuz - My Listings Seller Dashboard</title>
  <meta charset="utf-8">
...
<div>
<div class="my-destboard"><a href="switch-to-seller-dashboard.html">My Dashboard</a></div>
<div class="My-Packages"><a href="my-packages-seller-dashboard.html">My Packages</a></div>
<div class="listing-active"><a href="my-listings-seller-dashboard.html">My Listings</a></div>
...
<div class="dropdown dashboard">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  <div class="my-destboard"><a href="myadvertsBuyer">My Dashboard</a></div>
   <div class="My-Packages"><a href="my-packages-seller-dashboard.html">My Packages</a></div> 
   <div class="Favorites"> <a href="favourites-dashboard.html">Favorites</a></div>
   <div class="Saved-Search"><a href="saved-search-buyer-dashboard.html">Saved Search</a></div>
<div class="Messages"><a href="messages-dashboard.html">Messages</a></div>
...
<div class="warpper">
  ...
  <!-- tab area start -->
  <div class="tabs-1">
  <label class="tab" id="one-tab" for="one">Business <span class="number-count">0</span></label>
  <label class="tab" id="two-tab" for="two">Commercial <span class="number-count">0</span></label>
  <label class="tab" id="three-tab" for="three">Franchise <span class="number-count">0</span></label>
    </div>
	<!-- tab area finish -->
